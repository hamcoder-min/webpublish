...
export function BestProductImage({img, style, rank, like, icon, icon_style, cartCount}) {
    ...
    //index.js의 StrictMode가 해제되어 있는 경우, 개발자가 객체, 배열 등을 코드로 체크 로직
    // const {bg, color, radius, width, height} = icon_style || {};    //icon_style이 있으면 {bg, color, radius, width, heigth}실행, 없으면 실행 X

...
/**
 * ProudctDetail > Review > ReviewTop > ReviewType
 */
    ...
    return(
        <div className='review-list-item'>
            <div className='pdt_review_info'>
                <div className='prodcut_review_info_left'>
            ...
            <div className='pdt_review_detail'>
                <p className='pdt_review_text'>
                    사진보다ㅈ색이 연해서 더 맘에드네요. 옷은무겁습니다. 두꺼워서 따뜻하겠어요
                </p>
            </div>

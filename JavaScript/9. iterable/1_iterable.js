 ...
 * - ...(Destructuring object : 구조 분해 할당) : 객체의 구조를 분해하여 대입하는 변수에 자동으로 매핑
...
//Number 클래스는 iterable object가 아니므로 for..of 사용X
// console.clear();
const numbers2 = new Number(12345);
// for(const number2 of numbers2) console.log(number2);